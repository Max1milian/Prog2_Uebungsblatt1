...
unsigned short einlesenZahl()
{
    ...
    std::cin >> zahl;
    if (zahl < 1 || zahl > 9999)
    { // hier überprüfen wir ob die Zahl entweder
...
bool istZehner(const kennzeichen *pKennzeichen)
{
    ...
    {
        std::cout << "Die Zahl " << pKennzeichen->zahl << " ist eine Zehnerzahl" << std::endl;
        return true;
    }
    else
    {
        std::cout << "Die Zahl " << pKennzeichen->zahl << " ist keine Zehnerzahl" << std::endl;
        return false;
    }
}
...
bool istHunderter(const kennzeichen *rKennzeichen)
{
    ...
    {
        std::cout << "Die Zahl " << rKennzeichen->zahl << " ist eine eine Hunderterzahl" << std::endl;
        return true;
    }
    else
    {
        std::cout << "die Zahl " << rKennzeichen->zahl << " ist keine Hunderterzahl" << std::endl;
        return false;
    }
}
...
{
    if (pKennzeichen->zahl > 1000 && pKennzeichen->zahl % 1000 == 0)
    {
        std::cout << "Die Zahl " << pKennzeichen->zahl << " ist eine Tausenderzahl! " << std::endl;
        return true;
    }
    else
    {
        std::cout << "Die Zahl " << pKennzeichen->zahl << " ist keine Tausenderzahl!" << std::endl;
        return false;
    }
}
